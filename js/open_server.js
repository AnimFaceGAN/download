...
server.on('request', function(req, res)
{
    ...
    if (req.url == '../ja/land')
    {
        filename = '../ja/land.html';
    }
    else if (req.url == '/ja/about')
    {
        filename = '../ja/about.html';
    }
    else if (req.url == '/ja/news')
    {
        filename = '../ja/news.html';
    }
    else if (req.url == '/ja/download')
    {
        filename = '../ja/download.html';
    }
